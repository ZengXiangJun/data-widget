...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Navigator = __webpack_require__(33);
...
/***/ (function(module, exports) {
	...
	module.exports = {
		beforeExit: 'Are you sure to exit?',
	    logoutFailedMsg: 'Failed to logout, please close window directly.',
	    newWin: 'New Window',
	    sessionTimeoutTips: 'Your session has been expired, please relogin.',
	    themeSetting: 'Theme Setting',
	    theme: 'Theme',
	    logout: 'Logout',
	    message: 'Message',
	    error: 'Error',
	    debugInfo: 'Debug Info(will not show in production):',
	    invalidVar: '[Dev Error] Invalid variable name: ',
	    noProfileErr: '[Dev Error] Can not create an element without profile.',
	    invalidWinNoCheck: '[Dev Error] Invalid window number for window check, please check whether the window is existed or not. Window No. : ',
	    noValidation: '[Widget Error] No validation result is returned. ',
	    callThenTimeout: '[Widget Dev Error] The then method of promise object is not called or timeout in isValid function which is defined by widget.',
	    invalidJump: '[Dev Error] Can not jump from {{srcId}} to {{tarId}} due to they are not contained in the same frame.',
	    invalidAffect: '[Dev Error] Can not affect target: ',
	    invalidReset: '[Dev Error] Can not reset {{tarId}} due to they are not contained in the same frame.',
	    invalidPop: '[Dev Error] Can not pop target: ',
	    invalidPush: '[Dev Error] Can not push target: ',
	    widgetInitErr: '[Dev Error] Widget [{{name}}] has not been implemented or has error. Instance ID: {{id}}',
	    widgetNoIsValidFunc:'[Widget Dev Error] The isValid function is not implemented by this window widget: ',
	    noSrcId: '[Widget Dev Error] Must specify source id for getSourceData.',
	    invalidSrcId: '[Widget Dev Error] Invalid datasource id: ',
	    reRegWidgetErr: '[Widget Dev Error] Widget [{{name}}] can not be registered again!',
	    lpSyntaxErr: '[Dev Error] Local process function has syntax error: ',
	    lpExeErr: '[Dev Error] Error occured when executing local process: ',
	    invalidStatic: '[Dev Error] Invaild JSON data in static datasource. ',
	    invalidHttpJson: '[Dev Error] Invaild JSON data responsed from http proxy request. ',
	    invalidExportUrl: '[Dev Error] Invaild criteria to get export url.',
	    customInterfaceErr: '[Dev Error] Error occured when request custom interface {{name}}',
	    getServerContextErr: 'Failed to get Variable data from server.',
	    noWidget: 'This window has no widget set to show.',
	    ...
	    save: 'Save',
	    saveAs: 'Save As',
	    invalidCond: '[Dev Error] Invalid boolean expression: {{exp}}',
	    scriptErr: '[Dev Error] Script error caused by:',
	    dscallbackErr: "[Dev Error] Error occured when executing the callback after getting source data. See more details in console.",
	    befSyntaxErr: '[Dev Error]The before-enter-function has syntax error: {{message}}. See more details in console.',
	    cannotEnter: 'Can not enter system, because {{message}}',
	    befExError: '[Dev Error] Error occured when executing before-enter-script {{message}}. See more details in console.',
	    close: 'Close',
	    invalidWinNoAff: '[Dev Error] The window {{wno}} not found. Please check if the window number is correct in addition affect settings。Event: {{event}}'
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers.unless.call(alias1,(depth0 != null ? depth0.isStandalone : depth0),{"name":"unless","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    ...
	    + alias3(alias2(((stack1 = (depth0 != null ? depth0.locale : depth0)) != null ? stack1.preview : stack1), depth0))
	    + "\" class=\"preview fa fa-play ui-corner-all ui-state-default\"></i>\n      <i id=\"saveProfile\" title=\""
	    + alias3(alias2(((stack1 = (depth0 != null ? depth0.locale : depth0)) != null ? stack1.save : stack1), depth0))
	    + "\" class=\"save fa fa-save ui-corner-all ui-state-default\"></i>\n      <i id=\"saveAs\" title=\""
	    + alias3(alias2(((stack1 = (depth0 != null ? depth0.locale : depth0)) != null ? stack1.saveAs : stack1), depth0))
	    + "\" class=\"save fa fa-file-alt ui-corner-all ui-state-default\"></i>\n  </div>\n</div>\n<div class=\"bg-mask\"></div>";
	},"useData":true});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var locale = __webpack_require__(4);
	var themeSelector = __webpack_require__(29);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var handle = __webpack_require__(35);
	var Navigator = {
	  ...
	  __bindEvent: function() {
	    ...
	    var root = $('#navigator ul.menu.root');
	    root.on('click', 'li[isleaf=Y] label', function() {
	      root.find('.ui-state-active').removeClass('ui-state-active');
	      var li = $(this).closest('li');
	      li.addClass('ui-state-active');
	      var id = li.children('a').attr('navto');
	      $('#config-frame').prop('src', '/src/configurator/configurator.html?id=' + id);
	    });
